...
local servers = { "clangd", "ts_ls", "lua_ls", "eslint", "jedi_language_server", "jsonls", "dockerls", "bashls", "docker_compose_language_service", "jdtls", "marksman", "powershell_es", "terraformls", "sqls", "vimls", "bicep", "yamlls" }
